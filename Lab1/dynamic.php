...
<body>
    ...
    <form id="submitform" class="form-signin" method="post" style="margin-left:100px;margin-right:200px;">
        <div class="text-center">   
            <div id="form-error"></div>
            <img style="margin-bottom:30px;" width="70%" height="70%" src="logo-1.png" alt="">
            </div>
        ...
        <div class="form-label-group">
            <input name="first_name" type="text" id="firstname" class="form-control" placeholder="First Name" required autofocus>
            <label for="firstname">First Name</label>
        </div>

        <div class="form-label-group">
            <input name="last_name" type="text" id="lastname" class="form-control" placeholder="Last Name" required>
            <label for="lastname">Last Name</label>
        </div>

        <div class="form-label-group">
            <input name="city_name" type="text" id="cityname" class="form-control" placeholder="City Name" required>
    ...
    $('#submitform').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(response)
            {
                ...
                jsonData['color'] = response.message === "Save Operation Was Successful" ? 'alert-success':'alert-danger'
 
                $('#form-error').html('<div class="alert '+jsonData.color+' alert-dismissible fade show" role="alert">'+jsonData.message+'<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>')
           },
