...
<html lang="en">
  <head>
    ...
    <script src="../Lab1/js/placeorder.js"></script>
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <form name="order_form" id="order_form" class="form-signin">
                    ...
                    <input type="hidden" name="order_status" id="order_status" class="form-control" placeholder="Unit Price" required value="Order Placed">
          ...
          <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
              ...
              <form name="order_status_form" id="order_status_form" class="form-signin">
                    ...
                    <button id="btn-get-order" class="btn btn-lg btn-warning" style="margin: 20px;" type="submit">Check Order Status</button>
                </form>
              </div>
            </div>
          </div>
